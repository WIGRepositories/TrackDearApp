...
var myapp1 = angular.module('test', []);
...
var myCtrl = myapp1.controller('testCtrl', function ($scope, $http) {

    $http.get('http://localhost:1240/api/Tracking/GetUserLoc?mobileno=8801744404').then(function (res, data) {
        $scope.UserList = res.data;
        googleMapGenerator.options.locations = $scope.UserList;
    });
